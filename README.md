...
Select Java 8
```bash
update-alternatives --config java # Select jdk 11 # openjdk-8 doesn't work anymore.
``` 
...
### On the new version try with the snap version
apt install chromium-browser/jammy-updates chromium-chromedriver/jammy-updates
```bash
On ubuntu 22.04
